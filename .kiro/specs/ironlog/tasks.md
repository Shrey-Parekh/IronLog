...
- [ ] 2.5 Analytics Dashboard (basic)
  - [ ] 2.5.1 Create src/stores/analyticsStore.ts
  - [ ] 2.5.2 Create src/hooks/useAnalytics.ts
  - [ ] 2.5.3 Create src/components/VolumeChart.tsx (horizontal bar — volume per muscle group)
  - [ ] 2.5.4 Create src/components/StrengthChart.tsx (line chart — e1RM over time)
